...
@section('content')
    <div class="card">
        ...
        @endif
        <div class="card-body">
            <form class="row g-3" action="{{ route('register', ['type' => 'author']) }}" method="POST">
                @csrf
                ...
                <div class="col-md-6 form-floating">
                    <textarea class="form-control" placeholder="" id="bio" name="bio" style="height: 100px"><?= old('bio') ?></textarea>
                    <label for="bio">Biography</label>
                </div>
                <div class="col-md-6 form-floating">
                    <textarea class="form-control" placeholder="" id="genres" name="genres" style="height: 100px"><?= old('genres') ?></textarea>
